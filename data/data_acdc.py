...
def load_and_maybe_process_data(input_folder,
    ...
    data_file_name = 'data_%s_size_%s_res_%s_cv_fold_%d_all_labels.hdf5' % (mode, size_str, res_str, cv_fold_num)
...
if __name__ == '__main__':
    ...
    input_folder = sys_config.orig_data_root_acdc
    preprocessing_folder = sys_config.preproc_folder_acdc

    d = load_and_maybe_process_data(input_folder,
                                    preprocessing_folder,
                                    mode = '2D',
                                    size = (256, 256),
