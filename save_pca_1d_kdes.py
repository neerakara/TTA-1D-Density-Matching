...
parser.add_argument('--train_dataset', default = "RUNMC") # RUNMC / CSF / UMC / HCPT1
...
def main():
    ...
    with tf.Graph().as_default():
        ...
        for channel in range(num_channels):
            ...
            # ====================
            if (redraw == True) or (tf.gfile.Exists(pca_figures_dir + 'SD_features_c' + str(channel) + '.png') == False):
            ...
            # ====================
            if (redraw == True) or (tf.gfile.Exists(pca_figures_dir + 'SD_patches_c' + str(channel) + '.png') == False):
            ...
            # ====================
            if (redraw == True) or (tf.gfile.Exists(pca_figures_dir + 'pcs_c' + str(channel) + '.png') == False):
